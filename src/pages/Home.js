                        ...
                        <div className="mx-auto py-5 sm:py-5 lg:max">
                            <div className="mt-6 space-y-12 lg:grid lg:grid-cols-4 lg:gap-x-6 lg:space-y-0">
                                ...
                                <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md bg-gray-800 border-gray-700">
                                    <a href="/student">
                                        <img className="rounded-t-lg" src="https://img.freepik.com/free-vector/happy-diverse-students-celebrating-graduation-from-school_74855-5853.jpg?w=2000" alt="" />
                                        <div className="p-5">
                                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">Students ({students.length})</h5>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md bg-gray-800 border-gray-700">
                                    <a href="/course">
                                        <img className="rounded-t-lg" src="https://www.kdu.ac.lk/wp-content/uploads/2021/09/short-Courses.jpg" alt="" />
                                        <div className="p-5">
                                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">Courses ({courses.length})</h5>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md bg-gray-800 border-gray-700">
                                    <a href="/lecturer">
                                        <img className="rounded-t-lg" src="https://www.wessexscene.co.uk/wp-content/uploads/2016/10/PowerpointLecture.jpg" alt="" />
                                    </a>
                                    <div className="p-5">
                                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">Lectures ({lecturers.length})</h5>
                                    </div>
                                </div>
