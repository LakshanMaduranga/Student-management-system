...
export default function UpdateCourse() {
    ...
    const { name, description, courseCode } = courses;
    ...
    const onSubmitForm = async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:8081/courses/${id}`, courses)
        navigate("/course")
    }
                ...
                <div className="py-5 text-center">
                    <header className="bg-white shadow">
                        <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900">Update {courses.name}</h1>
                        </div>
                    </header>
                                ...
                                <div className="overflow-hidden shadow sm:rounded-md">
                                    <div className="bg-white px-4 py-5 sm:p-6">
                                        ...
                                        <div className="text-right py-5">
                                            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update Course</button>
